    ...
    <div className="min-h-screen">
      <div className="max-w-4xl mx-auto p-6 space-y-8">
        ...
        <div className="text-center pt-8">
          <h1 className="text-4xl font-bold mb-2">KeyVelocity</h1>
          <p className="text-lg">Master your keyboard. Test and improve your typing speed.</p>
        </div>
          ...
          <CardContent>
            {testResult ? (
              ...
              <div className="text-center py-8">
                <div className="text-lg">Take a test to see your progress.</div>
                <div className="text-sm mt-2">Configure your test above and click &quot;Start Test&quot; to begin.</div>
              </div>
            )}
          </CardContent>
        </Card>
